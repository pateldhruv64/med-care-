...
const addMedicine = async (req, res) => {
  ...
  if (medicine) {
    ...
    // Real-time update
    emitMedicineUpdate(req.io, { action: 'create', medicine });
...
const updateMedicine = async (req, res) => {
  ...
  // Real-time update
  emitMedicineUpdate(req.io, { action: 'update', medicine });
...
const deleteMedicine = async (req, res) => {
  ...
  // Real-time update
  emitMedicineUpdate(req.io, { action: 'delete', id: req.params.id });
