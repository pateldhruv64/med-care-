            ...
            <div className="mt-2 flex items-center gap-2 sm:gap-3 text-cyan-100 flex-wrap text-sm sm:text-base">
              {isCheckedIn && (
                <>
                  ...
                  <span
                    className={`px-2 py-0.5 rounded-full text-xs font-bold ${todayStatus.status === 'Late' ? 'bg-yellow-400 text-yellow-900' : 'bg-green-400 text-green-900'}`}
                  >
                    {todayStatus.status}
                  </span>
                </>
                ...
                {myRecords.map((record) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-3">
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-bold ${statusBadge(record.status)}`}
                      >
                        {record.status}
                      </span>
                    </td>
